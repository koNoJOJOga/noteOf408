...
&emsp;&emsp;&ensp;ADD Rd Rs Rt在单周期处理器下，指令执行周期的控制信号为：RegWr:1，ExtOp:0，ALUSrc:0，ALUctr:add，RegDst:0，MemWr:0，MemtoReg:0，Branch:0
...
&emsp;&emsp;&ensp;Store Rt Rs imm16指令在单周期处理器下执行周期的控制信号为：
